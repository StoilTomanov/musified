...
const lessonSchema = new Schema({
    ...
    duration: { type: Number, required: [true, 'Duration is required'] }, // TODO: consider changing the tipe to string so you can pass either minutes, hours, etc.
    videoUrl: { type: String, required: [true, 'Viedo Url address is required'] },
    imagePreviewUrl: { type: String, default: '../no_image.png' },
